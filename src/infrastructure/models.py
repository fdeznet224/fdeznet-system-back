...
class ConfiguracionCorreoBancoModel(Base):
    ...
    cuentas_destino_permitidas = Column(String(255), nullable=True)
...
class TransaccionCorreoBancoModel(Base):
    ...
    cuenta_destino_terminacion = Column(String(4), nullable=True, index=True)
...
class InstalacionSistemaModel(Base):
    ...
    bootstrap_hash = Column(String(64), unique=True, nullable=True)
    bootstrap_expira = Column(DateTime, nullable=True)
